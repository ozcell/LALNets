...
from phdwork.acol.regularizers import activity_acol, activity_acol_null
...
def define_cnn(input_shape, nb_classes, cnn_type=1, conv_params=(32,3,2), hidden_drop = True,
    ...
    if (c1 == 0.) and (c2 == 0.) and (c4 == 0.):
        model.add(Dense(nb_classes*K, activity_regularizer=activity_acol_null(c3), name='L-1'))
    else:
